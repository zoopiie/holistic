  ...
  while cap.isOpened():
    ...
    if results.multi_hand_landmarks:
      ...
      if results.multi_hand_landmarks != None:
          ...
          if handLandmarks.landmark[5].x > handLandmarks.landmark[17].x and maindoite == 0:
              maindoite = 1

              if 0<= int(handLandmarks.landmark[12].y) <= 1 :
                ...
                print('red', red, 'green', green, 'blue', blue, 'lum', lum)
